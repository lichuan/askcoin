...
7. ![gen_reg_sign](res/gen_reg_sign.jpg)

8. Now you can register a new account by executing the ***reg_account*** command, which requires entering your account name, your avatar ID (ranging from 1 to 100), and the signature string generated by your referrer:
